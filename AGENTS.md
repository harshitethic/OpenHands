...
- Frontend copy, i18n, shared string identifiers, and discriminated-union naming rules live in [`.agents/skills/frontend-conventions/SKILL.md`](.agents/skills/frontend-conventions/SKILL.md). Load that skill when changing React UI copy, translation keys, query/storage keys, routes, feature identifiers, or string-literal unions.
